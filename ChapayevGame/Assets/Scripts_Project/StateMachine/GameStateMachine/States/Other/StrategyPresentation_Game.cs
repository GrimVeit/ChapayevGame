...
public class StrategyPresentation_Game : IState
{
    ...
    public StrategyPresentation_Game(IGlobalStateMachine stateMachine, UIMiniGameSceneRoot sceneRoot, StrategyBuyPresenter strategyBuyPresenter, StoreStrategyPresenter storeStrategyPresenter, IParticleEffectProvider particleEffectProvider)
    {
