...
public class LoadBuyChip_Game : IState
{
    ...
    public LoadBuyChip_Game(IGlobalStateMachine stateMachine, UIGameRoot sceneRoot, IAnimationFrameProvider animationFrameProvider, ISoundProvider soundProvider)
    {
