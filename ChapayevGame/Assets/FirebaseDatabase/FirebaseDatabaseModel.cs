...
public class FirebaseDatabaseModel
{
    ...
    {
        //Record = PlayerPrefs.GetInt(PrefsKeys.RECORD, 0);
    ...
    public void CreateNewAccountInServer()
    {
        ...
        //Record = 0;
        //PlayerPrefs.SetInt(PrefsKeys.RECORD, 0);
    ...
    {
        var task = databaseReference.Child("Cs_Chap").GetValueAsync();
    ...
    {
        var task = databaseReference.Child("Link_Chap").GetValueAsync();
